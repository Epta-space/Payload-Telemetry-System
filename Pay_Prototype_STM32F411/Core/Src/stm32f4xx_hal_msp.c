...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SPI_SD_SCK_Pin|SPI_SD_MISO_Pin|SPI_SD_MOSI_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PA11     ------> SPI4_MISO
    */
    HAL_GPIO_DeInit(GPIOA, SPI_IMU_MOSI_Pin|SPI_IMU_MISO_Pin);

    HAL_GPIO_DeInit(SPI_IMU_SCK_GPIO_Port, SPI_IMU_SCK_Pin);
